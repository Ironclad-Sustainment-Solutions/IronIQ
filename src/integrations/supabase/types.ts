    ...
    Tables: {
      ...
      assessment_questions: {
        Row: {
          ...
          required_evidence: Database["public"]["Enums"]["evidence_type"] | null
          sort_order: number
          weight: number
        }
        Insert: {
      ...
      cap_observations: {
        Row: {
          ...
          evidence_type: Database["public"]["Enums"]["cap_evidence_type"] | null
          file_path: string | null
          frequency: string | null
          id: string
        ...
        Insert: {
          ...
          evidence_note?: string | null
          evidence_type?:
            | Database["public"]["Enums"]["cap_evidence_type"]
            | null
          file_path?: string | null
          frequency?: string | null
          id?: string
      ...
      programmer_approvals: {
        Row: {
          ...
          simulation_status:
            | Database["public"]["Enums"]["simulation_status"]
            | null
        }
        Insert: {
          acknowledged?: boolean
      ...
      rfq_requirements: {
        Row: {
          ...
          requested_machine_type:
            | Database["public"]["Enums"]["machine_type"]
            | null
